...
class StudentDetails extends Component {
    ...
    onChange(e) {
        ...
        // Auto-set hostel based on gender selection
        if (name === 'gender') {
            if (value === 'MALE') {
                this.setState({ hostel: 'BOYS HOSTEL' });
            } else if (value === 'FEMALE') {
                this.setState({ hostel: 'GIRLS HOSTEL' });
            } else {
            ...
            <div className="mid container">
                ...
                <form onSubmit={this.onSubmit}>
                    <div className="row">
                        ...
                        <div className="col">
                            <label htmlFor="hostel">Hostel (Auto-set based on Gender)</label>
